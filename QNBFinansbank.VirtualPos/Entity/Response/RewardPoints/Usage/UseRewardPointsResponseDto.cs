namespace QNBFinansbank.VirtualPos.Entity.Response.RewardPoints.Usage
{
    ...
    /// </summary>
    public class UseRewardPointsResponseDto : IDto
    {
        /// <summary>
        ...
        /// <summary>
        /// Para puan kullanım işlemi sonucu elde edilen detaylı bilgileri içeren <see cref="UseRewardPointsResponseDataDto"/> nesnesi.
