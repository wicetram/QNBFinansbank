...
namespace QNBFinansbank.VirtualPos.Entity.Request.Payment.ThreeD
{
    /// <summary>
    /// 3D ödeme işlemi için gerekli parametreleri temsil eden DTO.
    /// </summary>
    public class ThreeDPaymentRequestDto : IDto
    {
        /// <summary>
        /// Kurum kodudur. 
        ...
        /// <summary>
        /// Başarılı işlem sonrası yönlendirilecek URL.
        /// </summary>
        [XmlElement(ElementName = "OkUrl", Namespace = "")]
        public string? OkUrl { get; set; }

        /// <summary>
        /// Başarısız işlem sonrası yönlendirilecek URL.
        /// </summary>
        [XmlElement(ElementName = "FailUrl", Namespace = "")]
        public string? FailUrl { get; set; }

        /// <summary>
        /// İşlem için oluşturulmuş hash değeri.
        /// </summary>
        [XmlElement(ElementName = "Hash", Namespace = "")]
        public string? Hash { get; set; }

        /// <summary>
        /// Rastgele değer. Genellikle güvenlik amacıyla kullanılır.
        /// </summary>
        [XmlElement(ElementName = "Rnd", Namespace = "")]
